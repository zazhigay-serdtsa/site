...
import HeaderLogo from '../../assets/logoNew.png'
import style from './Footer.module.css';

const Footer = () => {
  return <div className={style.wrapper} id="footer">
    <div className={style.info}>
      ...
      <div className={style.contact}>
        Email:<a href="mailto:zajigay-serdca@mail.ru" className={style.email}>zajigay-serdca@mail.ru</a>
        <br />
        Телефон: +79525751901
        <br />
        Директор - Бартенева Сенильга Эмильевна
        <br />
        <a href="https://vk.com/luch_nadezhdy" className={style.vk}>
    ...
    <div className={style.endPage}>
      ...
      <button className={style.button}>
        <a href="mailto:zajigay-serdca@mail.ru" className={style.button}>
          Cвязаться с нами
        </a>
      </button>
    </div>
